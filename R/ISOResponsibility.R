...
#' @return Object of \code{\link{R6Class}} for modelling an ISO responsibility
#' @format \code{\link{R6Class}} object.
#'   
#' @references 
#'  - ISO 19115-3 \link{https://schemas.isotc211.org/19115/-3/cit/2.0/cit/#element_CI_Responsibility}
#' 
