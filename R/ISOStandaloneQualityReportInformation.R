...
#' @return Object of \code{\link{R6Class}} for modelling an ISO standalone quality report information
#' @format \code{\link{R6Class}} object.
#'
#' @references 
#'   - ISO 19115-3 \link{https://schemas.isotc211.org/19157/-/mdq/1.2/mdq/#element_DQ_StandaloneQualityReportInformation}
#' 
